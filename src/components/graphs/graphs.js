...
var chart = JSC.chart(
      ...
      customTicks: [
        {
          value: 12,
          label_text:
            "<icon name=weather/moon size=18 fill=#888987 ><br/>%valuePM",
        },
        {
          value: 19,
          label_text:
            "<icon name=linear/basic/alarm size=22 fill=#888987><br/>7AM",
        },
      ],
    },
    defaultSeries: {
  ...
  function (c) {
    ...
    c.series().points({ name: "Awake" }).options({ color: "#faf" }, false);
...
function tooltipFormatter(point) {
  ...
  return (
    "<b>%name " +
    "<br/>" +
    formatHour(point.y[0]) +
    " - " +
    formatHour(point.y[1])
  );
}
